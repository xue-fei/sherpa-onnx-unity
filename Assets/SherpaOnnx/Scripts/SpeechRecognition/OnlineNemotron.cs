...
{
    public class OnlineNemotron : SpeechRecognition
    {
        OnlineRecognizer recognizer = null;
        OnlineStream onlineStream = null;
        string tokensPath = "tokens.txt";
        string encoder = "encoder.int8.onnx";
        string decoder = "decoder.int8.onnx";
        string joiner = "joiner.int8.onnx";
        int numThreads = 1;
        ...
        void Init()
        {
            modelPath = pathRoot + "/sherpa-onnx-nemotron-speech-streaming-en-0.6b-int8-2026-01-14";
