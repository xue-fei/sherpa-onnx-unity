...
namespace SherpaOnnx
{
    ...
    {
        public static OnlineModelConfig Creat()
        {
            return new OnlineModelConfig
            {
                Transducer = OnlineTransducerModelConfig.Creat(),
                Paraformer = OnlineParaformerModelConfig.Creat(),
                Zipformer2Ctc = OnlineZipformer2CtcModelConfig.Creat(),
                Tokens = "",
                NumThreads = 1,
                Provider = "cpu",
                Debug = 0,
                ...
                TokensBuf = "",
                TokensBufSize = 0,
                NemoCtc = OnlineNemoCtcModelConfig.Creat(),
                ToneCtc = OnlineToneCtcModelConfig.Creat(),
            };
        }
