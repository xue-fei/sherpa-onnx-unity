...
namespace SherpaOnnx
{
    ...
    {
        public static OnlineRecognizerConfig Creat()
        {
            return new OnlineRecognizerConfig
            {
                FeatConfig = FeatureConfig.Creat(),
                ModelConfig = OnlineModelConfig.Creat(),
                ...
                HotwordsFile = "",
                HotwordsScore = 1.5F,
                CtcFstDecoderConfig = OnlineCtcFstDecoderConfig.Creat(),
                RuleFsts = "",
                RuleFars = "",
                BlankPenalty = 0.0F,
                HotwordsBuf = "",
                HotwordsBufSize = 0,
                Hr = HomophoneReplacerConfig.Creat(),
            };
        }
